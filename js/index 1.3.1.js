...
const options = {
  ...
  function uploadFile() {
    ...
    .then(data => {
        showAlert(true,`文件${file.name}上传成功！`)
...
function handleKeyPress(event) {
    ...
    // input_values_id.style.height = `${input_values_id.scrollHeight}px`;
}
...
function highlight_url(){
    var links = document.getElementsByTagName('li.a');
